...
MODEL              = dynamics_kinematics
MODULES            = dynamics_kinematics_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE           = dynamics_kinematics.mk
MATLAB_ROOT        = /usr/local/MATLAB/R2012a
ALT_MATLAB_ROOT    = /usr/local/MATLAB/R2012a
MASTER_ANCHOR_DIR  = 
START_DIR          = /home/simena/Dropbox/master_project/code/matlab
...
MODELLIB                  = dynamics_kinematicslib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/accel/dynamics_kinematics \
	-I$(START_DIR) \
