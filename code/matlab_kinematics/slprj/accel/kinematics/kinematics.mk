...
MODEL              = kinematics
MODULES            = kinematics_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE           = kinematics.mk
MATLAB_ROOT        = /usr/local/MATLAB/R2012a
ALT_MATLAB_ROOT    = /usr/local/MATLAB/R2012a
MASTER_ANCHOR_DIR  = 
START_DIR          = /home/simena/Dropbox/master_project/code/matlab_kinematics
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/accel/kinematics \
	-I$(START_DIR) \
