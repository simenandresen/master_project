...
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_testInstanceStruct *chartInstance, const
...
static void c2_b_emlrt_marshallIn(SFc2_testInstanceStruct *chartInstance, const
  mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y_data[6],
...
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_testInstanceStruct *chartInstance, const
...
static void c2_d_emlrt_marshallIn(SFc2_testInstanceStruct *chartInstance, const
  mxArray *c2_body_jacobian, const char_T *c2_identifier, real_T c2_y[72]);
static void c2_e_emlrt_marshallIn(SFc2_testInstanceStruct *chartInstance, const
  mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[72]);
static const mxArray *c2_f_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_f_emlrt_marshallIn(SFc2_testInstanceStruct *chartInstance,
...
static uint8_T c2_h_emlrt_marshallIn(SFc2_testInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
  ...
  mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_test = c2_g_emlrt_marshallIn(chartInstance,
  ...
  const mxArray *c2_b_is_active_c2_test, const char_T *c2_identifier)
{
  ...
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_y = c2_h_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_is_active_c2_test),
    &c2_thisId);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3195510374U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1363571479U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3173828881U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1946621543U);
}
...
mxArray *sf_c2_test_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("6x2SqpKSn1X4TZMtpxSmDB");
...
static const mxArray *sf_get_sim_state_info_c2_test(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Jacobian_body\",},{M[8],M[0],T\"is_active_c2_test\",}}"
  };
...
static void mdlSetWorkWidths_c2_test(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1734275061U));
  ssSetChecksum1(S,(3304544248U));
  ssSetChecksum2(S,(2833490086U));
  ssSetChecksum3(S,(2011863483U));
...
{
  SFc2_testInstanceStruct *chartInstance;
  chartInstance = (SFc2_testInstanceStruct *)malloc(sizeof
