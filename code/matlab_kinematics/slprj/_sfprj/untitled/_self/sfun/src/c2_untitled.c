...
static const char * c2_b_debug_family_names[4] = { "nargin", "nargout", "b", "a"
};
...
static void sf_c2_untitled(SFc2_untitledInstanceStruct *chartInstance)
{
  ...
  sf_debug_symbol_scope_add_eml_importable(&c2_b_nargout, 1U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_b, 2U, c2_sf_marshallOut,
    c2_sf_marshallIn);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1504815195U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1072577745U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(497405567U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4233917100U);
}
...
mxArray *sf_c2_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("P6nNhYiQiNQ1Dk0GTPB8cG");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML(0,1,2,0,0,0,0,0,0,0);
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,51);
        _SFD_CV_INIT_EML_FCN(0,1,"fcn2",53,-1,90);
...
static void mdlSetWorkWidths_c2_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3603628303U));
  ssSetChecksum1(S,(1478925668U));
  ssSetChecksum2(S,(3271010349U));
  ssSetChecksum3(S,(3231647648U));
