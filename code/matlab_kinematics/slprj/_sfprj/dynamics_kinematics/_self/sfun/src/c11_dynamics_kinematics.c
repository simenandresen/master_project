...
static void initialize_c11_dynamics_kinematics
  (SFc11_dynamics_kinematicsInstanceStruct *chartInstance);
static void initialize_params_c11_dynamics_kinematics
  (SFc11_dynamics_kinematicsInstanceStruct *chartInstance);
static void enable_c11_dynamics_kinematics
  (SFc11_dynamics_kinematicsInstanceStruct *chartInstance);
static void disable_c11_dynamics_kinematics
  (SFc11_dynamics_kinematicsInstanceStruct *chartInstance);
static void c11_update_debugger_state_c11_dynamics_kinematics
  (SFc11_dynamics_kinematicsInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c11_dynamics_kinematics
  (SFc11_dynamics_kinematicsInstanceStruct *chartInstance);
static void set_sim_state_c11_dynamics_kinematics
  (SFc11_dynamics_kinematicsInstanceStruct *chartInstance, const mxArray *c11_st);
static void finalize_c11_dynamics_kinematics
  (SFc11_dynamics_kinematicsInstanceStruct *chartInstance);
static void sf_c11_dynamics_kinematics(SFc11_dynamics_kinematicsInstanceStruct
  *chartInstance);
static void initSimStructsc11_dynamics_kinematics
  (SFc11_dynamics_kinematicsInstanceStruct *chartInstance);
...
static const mxArray *c11_c_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static real_T c11_emlrt_marshallIn(SFc11_dynamics_kinematicsInstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId);
static void c11_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c11_mxArrayInData, const char_T *c11_varName, void *c11_outData);
static const mxArray *c11_d_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static void c11_b_emlrt_marshallIn(SFc11_dynamics_kinematicsInstanceStruct
  *chartInstance, const mxArray *c11_mtimes, const char_T *c11_identifier,
  real_T c11_y[6]);
static void c11_c_emlrt_marshallIn(SFc11_dynamics_kinematicsInstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId,
  real_T c11_y[6]);
static const mxArray *c11_e_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static int32_T c11_d_emlrt_marshallIn(SFc11_dynamics_kinematicsInstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId);
static void c11_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c11_mxArrayInData, const char_T *c11_varName, void *c11_outData);
static uint8_T c11_e_emlrt_marshallIn(SFc11_dynamics_kinematicsInstanceStruct
  *chartInstance, const mxArray *c11_b_is_active_c11_dynamics_kinematics, const
  char_T *c11_identifier);
static uint8_T c11_f_emlrt_marshallIn(SFc11_dynamics_kinematicsInstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId);
static void init_dsm_address_info(SFc11_dynamics_kinematicsInstanceStruct
  *chartInstance);
  ...
  (SFc11_dynamics_kinematicsInstanceStruct *chartInstance)
{
  ...
  chartInstance->c11_is_active_c11_dynamics_kinematics = 0U;
}
  ...
  (SFc11_dynamics_kinematicsInstanceStruct *chartInstance)
{
  ...
  c11_hoistedGlobal = chartInstance->c11_is_active_c11_dynamics_kinematics;
  ...
  (SFc11_dynamics_kinematicsInstanceStruct *chartInstance, const mxArray *c11_st)
{
  ...
  chartInstance->c11_is_active_c11_dynamics_kinematics = c11_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c11_u, 1)),
     "is_active_c11_dynamics_kinematics");
  sf_mex_destroy(&c11_u);
  c11_update_debugger_state_c11_dynamics_kinematics(chartInstance);
  ...
  *c11_inData)
{
  ...
  const mxArray *c11_y = NULL;
  SFc11_dynamics_kinematicsInstanceStruct *chartInstance;
  chartInstance = (SFc11_dynamics_kinematicsInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c11_dynamics_kinematics_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c11_identifier)
{
  ...
  c11_y = c11_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c11_b_is_active_c11_dynamics_kinematics), &c11_thisId);
  sf_mex_destroy(&c11_b_is_active_c11_dynamics_kinematics);
  return c11_y;
}
...
/* SFunction Glue Code */
void sf_c11_dynamics_kinematics_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c11_dynamics_kinematics_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c11_dynamics_kinematics(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"vehicle_rates\",},{M[8],M[0],T\"is_active_c11_dynamics_kinematics\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c11_dynamics_kinematics_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc11_dynamics_kinematicsInstanceStruct *chartInstance;
    chartInstance = (SFc11_dynamics_kinematicsInstanceStruct *)
...
static void sf_opaque_initialize_c11_dynamics_kinematics(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc11_dynamics_kinematicsInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c11_dynamics_kinematics
    ((SFc11_dynamics_kinematicsInstanceStruct*) chartInstanceVar);
  initialize_c11_dynamics_kinematics((SFc11_dynamics_kinematicsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c11_dynamics_kinematics(void *chartInstanceVar)
{
  enable_c11_dynamics_kinematics((SFc11_dynamics_kinematicsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c11_dynamics_kinematics(void *chartInstanceVar)
{
  disable_c11_dynamics_kinematics((SFc11_dynamics_kinematicsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c11_dynamics_kinematics(void *chartInstanceVar)
{
  sf_c11_dynamics_kinematics((SFc11_dynamics_kinematicsInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c11_dynamics_kinematics
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c11_dynamics_kinematics
    ((SFc11_dynamics_kinematicsInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c11_dynamics_kinematics();/* state var info */
...
extern void sf_internal_set_sim_state_c11_dynamics_kinematics(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c11_dynamics_kinematics((SFc11_dynamics_kinematicsInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c11_dynamics_kinematics(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c11_dynamics_kinematics(S);
}

static void sf_opaque_set_sim_state_c11_dynamics_kinematics(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c11_dynamics_kinematics(S, st);
}

static void sf_opaque_terminate_c11_dynamics_kinematics(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc11_dynamics_kinematicsInstanceStruct*) chartInstanceVar
      )->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c11_dynamics_kinematics((SFc11_dynamics_kinematicsInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc11_dynamics_kinematics((SFc11_dynamics_kinematicsInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c11_dynamics_kinematics(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c11_dynamics_kinematics
      ((SFc11_dynamics_kinematicsInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c11_dynamics_kinematics(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c11_dynamics_kinematics(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c11_dynamics_kinematics(SimStruct *S)
{
  SFc11_dynamics_kinematicsInstanceStruct *chartInstance;
  chartInstance = (SFc11_dynamics_kinematicsInstanceStruct *)malloc(sizeof
    (SFc11_dynamics_kinematicsInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc11_dynamics_kinematicsInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c11_dynamics_kinematics;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c11_dynamics_kinematics;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c11_dynamics_kinematics;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c11_dynamics_kinematics;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c11_dynamics_kinematics;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c11_dynamics_kinematics;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c11_dynamics_kinematics;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c11_dynamics_kinematics;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c11_dynamics_kinematics;
  chartInstance->chartInfo.mdlStart = mdlStart_c11_dynamics_kinematics;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c11_dynamics_kinematics;
...
void c11_dynamics_kinematics_method_dispatcher(SimStruct *S, int_T method, void *
  data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c11_dynamics_kinematics(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c11_dynamics_kinematics(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c11_dynamics_kinematics(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c11_dynamics_kinematics_method_dispatcher.\n"
